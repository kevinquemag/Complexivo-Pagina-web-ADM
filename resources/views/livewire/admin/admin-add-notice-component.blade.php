<section class="section section-sm section-last bg-default text-left">
    <div class="container">
        ...
        <form class="rd-form rd-form-variant-2 rd-mailform formulario-guardar"  wire:submit.prevent="addNotice">
        ...
        <button class="button button-primary button-pipaluk" type="submit">Guardar Noticia</button>           
        </form>
    </div>
</section>
@push('scripts')
