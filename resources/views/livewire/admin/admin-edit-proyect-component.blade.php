<section class="section section-sm section-last bg-default text-left">
    <div class="container">
        ...
        <form class="rd-form rd-form-variant-2 rd-mailform formulario-actualizar"  wire:submit.prevent="updateProject">
        <div class="row row-14 gutters-14">
            ...
            <div class="col-md-12" >
                ...
                <div class="col-md-4" >
                    ...
                    @else
                        <img src="{{asset('assets/images/home/proyectos')}}/{{$image}}" width="200" >
                    @endif
                    @error('newimage')<p class="text-danger" style="color: red; font-size: 11px;">La Imagen es requerida</p>@enderror
                </div>
            </div>
        </div>
        <button class="button button-primary button-pipaluk" type="submit">Actualizar Proyecto</button>           
        </form>
    </div>
</section>
@push('scripts')
