            ...
            <div class="panel-heading" style="padding-bottom: 10px;">
              <div class="row">
                  ...
                  <div class="col-md-6" style="text-align: right;">
                    <a class="button button-secondary button-pipaluk" href="{{ route('admin.noticias') }}">Regresar</a>
                  </div>
              </div>
            </div>

        <form class="rd-form rd-form-variant-2 rd-mailform formulario-actualizar"  wire:submit.prevent="updateNotice">
        <div class="row row-14 gutters-14">
            ...
            <div class="col-md-12" >
                ...
                <div class="col-md-4" >
                    ...
                    @else
                        <img src="{{asset('assets/images/home/noticias')}}/{{$image}}" width="200" >
                    @endif
                    @error('newimage')<p class="text-danger" style="color: red; font-size: 11px;">La Imagen es requerida</p>@enderror
                </div>
            </div>
        </div>
        <button class="button button-primary button-pipaluk" type="submit">Actualizar Noticia</button>           
        </form>
    </div>
</section>
